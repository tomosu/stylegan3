...
def main(**kwargs):
    ...
    if opts.aug != 'noaug':
        ...
        c.augment_kwargs = dnnlib.EasyDict(class_name='training.augment.AugmentPipe', xflip=1, rotate90=0, xint=1, scale=1, rotate=1, aniso=1, xfrac=0.2, brightness=0.4, contrast=0.2, lumaflip=0, hue=0.3, saturation=1)
        if opts.aug == 'ada':
